// Thailand's 77 provinces (จังหวัด), bilingual. "Remote / Anywhere" first,
// then "Bangkok" (the capital), then the remaining 76 alphabetically by English
// romanization. Used as a free-typeable autocomplete for the Location field;
// `provinceOptions(locale)` returns the list in the active language.

import type { Locale } from "./i18n";

export const PROVINCES: { en: string; th: string }[] = [
  { en: "Remote / Anywhere", th: "ที่ไหนก็ได้ / Remote" },
...
export function provinceOptions(locale: Locale): string[] {
