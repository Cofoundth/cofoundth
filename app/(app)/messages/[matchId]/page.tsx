...
export default async function MessagePage({ params }: Props) {
  ...
  return (
    // The grid, the dvh height and the collapse state live in
    // <ConversationLayout /> (a Client Component); both subtrees below stay
    // server-rendered and are handed to it as props.
    <ConversationLayout
      conversation={
        <>
