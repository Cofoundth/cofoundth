...
const TEMPLATES: Template[] = [
  ...
  },
  {
    ...
    description:
      "Standard SAFE template adapted for SEA jurisdictions.",
  },
  {
    category: "Fundraising",
    ...
    <div className="max-w-5xl mx-auto px-6 lg:px-10 py-20">
      <div className="mb-16 max-w-3xl">
        ...
        <p className="text-lg text-ink leading-relaxed">
          Templates founders most often need at the start. Reviewed by Thai
          lawyers. Free for the community.
        </p>
        <div className="mt-6 px-4 py-3 border border-gold/40 bg-cream text-sm text-ink leading-relaxed">
          <strong className="text-navy">Important:</strong> these are
          starting points, not legal advice. For real deals — fundraises,
          significant equity splits, exits — engage a lawyer.
        </div>
      </div>
      ...
      <div className="space-y-12">
        {CATEGORIES.map((cat) => (
          <section key={cat}>
            <h2 className="text-2xl mb-6 pb-3 border-b border-line">{cat}</h2>
